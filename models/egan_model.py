...
class EGANModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.output = None
        self.loss_names = ['G_real', 'G_fake', 'D_real', 'D_fake', 'D_gp', 'G', 'D', 'mode']
    ...
    def backward_G(self, gen_data):
        ...
        return loss_G, loss_G_fake, loss_G_real
    ...
    def Evo_G(self):
        ...
        for i in range(self.opt.candi_num):
            for criterionG in self.G_mutations: 
                ...
                gen_data = self.forward() 
                loss_G, loss_G_fake, loss_G_real = self.backward_G(gen_data)
                ...
                if fitness > G_heap.top().fitness:
                    ...
                    G_heap.replace(G_Net(fitness=fitness, G_candis=netG_dict, optG_candis=optmizerG_dict, loss_mode=criterionG.loss_mode, loss_G=loss_G, loss_G_fake=loss_G_fake, loss_G_real=loss_G_real))
        ...
        self.loss_G, self.loss_G_fake, self.loss_G_real = G_heap.array[max_idx].loss_G, G_heap.array[max_idx].loss_G_fake, G_heap.array[max_idx].loss_G_real 
